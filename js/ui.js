...
import { MEM_LOCATIONS, MEM_RECORDS, MEM_CENTERS, MEM_EXPENSE_ITEMS } from './data.js';
...
// 권역별 데이터 (원본 백업 데이터 기준 분류)
const QUICK_LOC_GROUPS = [
    { label: "⭐ 자주 가는 곳", isFrequent: true, items: ["남양주4", "MNYJ2", "고양1.CFC", "인천31.32.41.42", "안산1(SH)", "시흥2"] },
    { label: "인천 / 김포 / 부천", items: ["인천16", "인천26,28", "인천45", "MGMP", "부천2", "인천13", "인천4"] },
    { label: "남양주 / 구리 / 마장", items: ["남양주3", "구리3", "남양주(이패A,B)", "남양주1", "마장1"] },
    { label: "용인 / 안양 / 군포 / 이천", items: ["용인5", "안양1(SH)", "군포1", "시흥1", "이천2", "이천3"] },
    { label: "안성 / 천안 / 세종 / 목천", items: ["안성5", "안성4", "목천1", "XRC12.성환", "XRC06.성거", "XHM5.천안", "XRC11.세종", "천안2", "천안6"] },
    { label: "공단 (시흥 / 안산 / XRC)", items: ["시흥3", "XRC13", "XRC10", "안산2", "안산3"] },
    { label: "광주 / 여주 / 서초", items: ["곤지암1", "곤지암2", "경광주3", "경광주4", "서초1(SH)", "여주1"] }
];
